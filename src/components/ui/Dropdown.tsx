...
//     triggerLabel?: string;
//     menuWidth?: number; // Add custom width prop
...
//     menuWidth = 136, // Compact default width (w-34 approx)
...
//             style={{ top: coords.top, left: coords.left, width: `${menuWidth}px` }} // Use dynamic width
//         >
...
//           }}
//           className={cn(
//             'w-full text-left flex items-center px-2.5 py-1.5 text-xs font-medium rounded transition-colors group outline-none', // Reduced padding & text size
...
//             <span
//               className={cn(
//                 'shrink-0 w-4 flex justify-center mr-2',
